...
def main():
    ...
    battles_cols = [
        "battle_id","player_tag","opponent_tag","battle_time","mode","arena","player_trophies",
        "opponent_trophies","player_crowns","opponent_crowns","is_ladder_tournament","battle_type","won"
    ]
        ...
        for i, tag in enumerate(tags[:n_players], start=1):
            try:
                ...
                for b in data:
                    ...
                    pt, ot = team.get("startingTrophies"), opp.get("startingTrophies")
